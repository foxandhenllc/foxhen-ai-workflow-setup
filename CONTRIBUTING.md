# Contributing to AI Workflow Setup

AI Workflow Setup is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A workflow setup kit for turning intake notes into scoped prompts, QA checks, risk gates, operator notes, and handoff packages.
